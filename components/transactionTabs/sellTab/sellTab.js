                ...
                <View>
                    <View style={style.commonTextInput}>
                        <View style={style.ImageAndTextInput}>
                            ...
                            <TextInput onBlur={() => onBlurCoin()} value={coinInputValue} placeholder={"Select Coins"} style={style.coinTextInput} onChangeText={(text) => onChangeCoinTextFunction(text)} onFocus={() => {
                                setCoinImage(null);
                        ...
                        <View style={style.centeredView}>
                            <View style={style.feeModalView}>
                                <View style={style.backIconAndText}>
                                    ...
                                    <TouchableOpacity onPress={() => setFeeModalVisible(!feeModalVisible)}>
                                        <EvilIcons style={style.popupCross} name='close' size={24} color='black' />
                                    </TouchableOpacity>
                                </View>
                                <TextInput maxLength={9} keyboardType={"numeric"} value={sellFee} onChangeText={(feeText) => buyFeeFunction(feeText)} placeholder="$" style={style.feePlaceholder}  ></TextInput>
                                <TouchableOpacity activeOpacity={0.9}
                                    style={style.buttonClose}
                                    onPress={() => {
                                        setFeeModalVisible(!feeModalVisible);
                                        setFee(addDecimals(sellFee));
                                    }}
                                >
